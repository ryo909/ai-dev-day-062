import './style.css';
const PROFILE = {"day":"Day062","title":"Gift Overlap Breaker","display_name_ja":"手土産かぶりほどき","one_sentence":"複数人の手土産候補のかぶりと不足を整えるツール","purpose_line_ja":"手土産候補のかぶりと不足を整えやすくするためのツールです。","use_case_line_ja":"複数人で手土産を持つ前に何を誰が持つか決めたい時に使います。","how_it_works_line_ja":"候補と予算を入れると、かぶり警告つきの担当割り当てが分かります。","core_action":"assign","family":"gift_overlap_assignment","mechanic":"coverage_assign","input_style":"participant_rows","output_style":"assignment_board","output_label":"ここを見ればOKです","audience_promise":"持っていく物と担当をその場で決められる。","publish_hook":"候補・予算・避けたい食材を自分で入れると、かぶりと不足が一画面で見えて担当まで決まる。","engine":"brief_driven","interaction_archetype":"coverage_assign","page_archetype":"gift_grid","ui_variant":"gift","intro_variant":"gift_assign","interaction_model":"edit_people_and_gift_candidates","primary_layout":"gift_candidates_with_assignment_board","result_presentation_style":"assignments_overlap_and_gaps","palette_motif":"手土産ラズベリー","main_cta":"3人の手土産で試す","input_panel_title":"参加者と候補を足す","sample_panel_title":"3人の手土産で試す","guide_panel_title":"かぶりの見どころ","hero_panel_label":"担当のまとまり","output_shape":"gift_grid","state_model":"coverage_assign_state","core_loop":"participant_rows -> coverage_assign -> assignment_board","component_pack":"gift_grid+assignment_board","scaffold_id":"brief_canvas","single_shot_text_generator":false};
